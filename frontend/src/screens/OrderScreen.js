        ...
        <Row>
            <Col md={8}>
                <ListGroup variant='flush'>
                    <ListGroup.Item>
                        <h2>Shipping</h2>
                        <p><strong><strong>Name: </strong></strong> {order.user.name}</p>
                        <p><strong><strong>Email: </strong></strong><a href={`mailto:${order.user.email}`}>{order.user.email}</a></p>
                        <p>
                            <strong><strong>Address: </strong></strong>
                ...
                <Card>
                    <ListGroup variant='flush'>
                        ...
                        <ListGroup.Item>
                            <Row>
                                <Col>Shipping</Col>
                                <Col>{Number(order.shippingPrice) === 0 ? 'FREE' : '$'+order.shippingPrice}</Col>
                            </Row>
                        </ListGroup.Item>
                        <ListGroup.Item>
                            <Row>
